<?php
// HTTP
define('HTTP_SERVER', 'http://www.ckmart4u.com/admin/');
define('HTTP_CATALOG', 'http://www.ckmart4u.com/');

// HTTPS
define('HTTPS_SERVER', 'http://www.ckmart4u.com/admin/');
define('HTTPS_CATALOG', 'http://www.ckmart4u.com/');
...
define('DB_USERNAME', 'jaycre_web');
define('DB_PASSWORD', 'web121');
define('DB_DATABASE', 'jaycre_web');
