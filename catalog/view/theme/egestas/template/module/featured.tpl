      ...
      <div>
       ...
       <?php } ?>
        ...
        <div class="price">
          ...
          <div style="background-color:#A00B00;min-width:80;"><span class="price-fixed"><?php echo $product['price']; ?></span></div>
          <?php } else { ?>
        ...
        <div class="wishlist"><a onclick="addToWishList('<?php echo $product['product_id']; ?>');"><span class="icon-wishlist-grey">Add to Wish List</span></a></div>
