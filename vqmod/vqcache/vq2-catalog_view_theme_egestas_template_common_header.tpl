...
<body class="primary-define color-teal<?php if (preg_match('#MSIE (.+?);#', $this->request->server['HTTP_USER_AGENT'], $matches) && intval($matches[1]) < 9) echo ' is-ie'; ?>">
<?php
if($route==1)
{?>
<div id="s" style="position:absolute;top:0px;width:100%;;height:430px;z-index:-1;">
</div>
<?php } ?>
<div id="header" style="font-size:18px;">
<div id="topbar">
...
<div class="wrapper clearafter">
  ...
  <?php } ?>
  <?php echo $cart; ?>
  <div id="search" style="padding-top:55px;">
  <div id="search-inner">
...
<div class="wrapper clearafter">
  <ul class="mainmenu clearafter">
    ...
    <li style="margin-left:8px;" class="item<?php echo count($category['children']) ? ' parent' : '' ?><?php echo $category_id === $cate ? ' active' : '' ?>"><a class="<?php echo $category_id === $cate ? 'current' : '' ?>" href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>
...
if($route==1)
{?>
  <hr color="#FFF" width="90%" width="2px"  align="left"/>
<?php } ?>
</div>
</div>
</div>
