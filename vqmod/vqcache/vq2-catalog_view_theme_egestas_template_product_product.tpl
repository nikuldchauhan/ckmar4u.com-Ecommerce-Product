...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    <?php if ($thumb || $images) { ?>
    <div class="left" style="width: <?php echo $this->config->get('config_image_thumb_width') + 22 ?>px;height:320px;">
...
style="height:300px;"><img src="<?php echo $thumb; ?>"  title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div>   
    ...
    <div class="right" style="margin-left: <?php echo $this->config->get('config_image_thumb_width') + 52 ?>px;">
      ...
      <div class="review">
        <img src="catalog/view/theme/egestas/image/icons/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" /><a class="show-review" href="#tabs"><?php echo $reviews; ?></a>
      ...
      <div class="price">
        <?php if (!$special) { ?>
		<div style="background-color:#A00B00;color:#000"><span class="price-fixed" style="background-color:#D3BC75;"><?php echo $price; ?></span></div>
        <?php } else { ?>
